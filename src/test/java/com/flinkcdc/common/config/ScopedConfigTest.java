...
import com.flinkcdc.common.config.ScopedConfig;
...
class ScopedConfigTest {
    ...
    void testRequireThrowsIfMissing() {
        IllegalStateException ex = assertThrows(
                ...
                () -> ScopedConfig.require("NOT_EXIST")
        );
        assertTrue(ex.getMessage().contains("NOT_EXIST"));
    }

    @Test
    @DisplayName("getOrDefault() should return the value if the key exists, or the default value if it does not")
