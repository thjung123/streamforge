        ...
        return input
                .map(new RichMapFunction<CdcEnvelop, CdcEnvelop>() {
                    ...
                    public void open(Configuration parameters) {
                        metrics = new Metrics(getRuntimeContext(), MongoToKafkaJob.JOB_NAME, MongoToKafkaJob.PROCESSOR_NAME);
                        DLQPublisher.getInstance().initMetrics(getRuntimeContext(), MongoToKafkaJob.JOB_NAME);
                    }
