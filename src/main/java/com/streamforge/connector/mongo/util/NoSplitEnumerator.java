...
public class NoSplitEnumerator implements SplitEnumerator<NoSplit, Void> {
  ...
  public void handleSplitRequest(
      int subtaskId, @org.checkerframework.checker.nullness.qual.Nullable String hostname) {
    if (!assigned) {
